...
static void mesh_default_transition_time_client_message_handler(uint16_t event, wiced_bt_mesh_event_t *p_event, void *p_data);
...
{
    wiced_bt_cfg_settings.device_name = (uint8_t *)"Mesh Control";
