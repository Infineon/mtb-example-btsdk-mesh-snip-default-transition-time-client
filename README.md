# Mesh snip application

## Overview
This app demonstrates the use of a Bluetooth&#174; SIG Low Energy Mesh model as indicated by the name of the application.
...
2. Run the application and refer to the Mesh Client Control user guide.
   Refer to Bluetooth&#174; SIG Mesh Specification:
...
2. The default PUART baud rate is set in that location to 921600
